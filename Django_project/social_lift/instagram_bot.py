...
# print(insta_post("hello there", r"C:\Users\john1\Documents\SummerTraining\Django_project\media\assignment_1_RPA.png",
#                  (1080, 1080), email="anonymous.it.iter@gmail.com", password="elgooghtiwpungiS"))
